...
//!
//! For batch verification scenarios, consider [`VrfDraft13`](crate::VrfDraft13).
...
impl VrfDraft03 {
    ...
    /// # Errors
    ///
    /// Returns [`VrfError`](crate::VrfError) if:
    ...
    ///
    /// Checks that the proof was generated by the holder of the secret key corresponding
    /// to `public_key` for the given `message`. On successful verification, returns the
    ...
    /// # Returns
    ///
    /// 64-byte VRF output hash (SHA-512 of cofactor-cleared Gamma)
    ///
    /// # Errors
    ///
    /// Returns [`VrfError::InvalidPoint`](crate::VrfError::InvalidPoint) if the
    /// Gamma bytes in the proof cannot be decoded as a valid Edwards curve point.
    ///
    /// # Examples
    ///
    /// ```rust
